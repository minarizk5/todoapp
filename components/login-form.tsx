...
export default function LoginForm() {
  ...
  // Check if redirected from signup with success parameter
  ...
  if (errorType) {
    switch (errorType) {
      ...
      case "OAuthSignin":
      case "OAuthCallback":
        errorMessage = "There was a problem with the Google sign in"
        break
  ...
  const handleGoogleSignIn = () => {
    ...
    // Use a direct form submission approach to avoid client-side errors
